 ...
 * @author Ciccio
 */
public class SportPlannerGUI extends javax.swing.JFrame {
    private SportPlanner sportPlanner;
    /**
     * Creates new form SportPlanner
     */
    public SportPlannerGUI() {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Inserisci nuovo torneo");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new InserisciNuovoTorneoGUI(sportPlanner);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SportPlannerGUI().setVisible(true);
            }
        });
    }
